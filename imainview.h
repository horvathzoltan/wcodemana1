...
public:
    ...
    virtual MainViewModel::Text get_ContentSearcText() = 0;
...
/*search*/
    ...
    virtual void set_SearchContent(const MainViewModel::SearchR2 &m) = 0;
    virtual void set_SearchCounter(const MainViewModel::SearchCounterR &m) = 0;
    virtual void set_SearchContentCounter(const MainViewModel::SearchCounterR &m) = 0;

    virtual void set_SearchToken(const MainViewModel::Text& m) = 0;
    virtual void set_SetListWidget(const MainViewModel::SearchCounterR& m) = 0;
...
public: // signals
    ...
    virtual void SearchPrevTriggered(IMainView *sender) = 0;
    virtual void ContentSearchPrevTriggered(IMainView *sender) =0;
    virtual void ContentSearchNextTriggered(IMainView *sender) =0;
